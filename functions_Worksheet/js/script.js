...
console.log("It takes " + stingsToKill "Bee stings to kill this animal.")function calcStingsPerPound(stingsPerPound, victimsWght){	return stingsPerPound * victimsWght;
} 